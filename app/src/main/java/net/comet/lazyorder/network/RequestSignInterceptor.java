...
public class RequestSignInterceptor implements Interceptor {
    ...
    public static byte[] hmacSha1WithSecret(String data, String secret) throws Exception {
     ...
     * @param out 参数对
     */
    protected void collectBodyParameters(Request request, Map<String, String> out) throws IOException {
     ...
     * @param out 参数对
     */
    protected void collectQueryParameters(Request request, Map<String, String> out) {
